...
class EnhancedTable extends Component {
  ...
  handleDeleteSelected = () => {
    this.props.deleteSlectedNews(JSON.stringify(this.state.selected));
  };
  ...
  handleDeleteButton = toBeDeleted => {
    if (!checkAuthorization("news_permissions", "can_delete_news")) {
      this.props.handleSnackBarMessage(
        "You don't have permission to delete News",
        "error"
      );
    } else {
    ...
    return (
      <div>
        <DeleteConfirmationDialog
          ...
          handleConfirmDelete={this.deleteNews}
        />
        <Paper className={classes.root}>
          <EnhancedTableToolbar
            ...
            delete={() => this.handleDeleteButton(selected)}
          />
                  ...
                  .map(n => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell padding="none">{n.PublishDate}</TableCell>

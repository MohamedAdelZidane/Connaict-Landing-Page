...
class EnhancedTable extends Component {
  ...
  handleDeleteSelected = () => {
    this.props.deleteSlectedAboutUs(JSON.stringify(this.state.selected));
  };
  ...
  handleDeleteButton = toBeDeleted => {
    if (!checkAuthorization("about_permissions", "can_delete_about")) {
      this.props.handleSnackBarMessage(
        "You don't have permission to delete About",
        "error"
      );
    } else {
    ...
    return (
      <div>
        <DeleteConfirmationDialog
          ...
          title="Deleting About"
          text="Are you sure you want to perform this action?"
          handleConfirmDelete={this.deleteAbout}
        />

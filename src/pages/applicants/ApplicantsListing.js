...
let filters = [
  { Field: "ArabicTitle", Type: "TEXT", Values: "", Operator: "TEXT_EQUAL" },
  { Field: "EnglishTitle", Type: "TEXT", Values: "", Operator: "TEXT_EQUAL" },
  {
    Field: "CreatedOn",
    Type: "DATE_RANGE",
    Values: [],
  ...
  handleDeleteButton = toBeDeleted => {
    if (
      ...
      this.props.handleSnackBarMessage(
        "You don't have permission to delete Applicant",
        "error"
      );
    } else {
                  ...
                  .map(n => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell component="th" scope="row" padding="none">
                          {n.Job[0] ? n.Job[0].EnglishName : "No Job"}
                        </TableCell>
                        <TableCell component="th" scope="row" padding="none">
                          <IconButton target="_blank" href={BASE_URL + n.CV}>
                            <DownloadIcon />
                          </IconButton>
                        </TableCell>
                        <TableCell component="th" scope="row" padding="none">
                        ...
                        <TableCell component="th" scope="row" padding="none">
                          <IconButton onClick={() => this.props.handleView(n)}>

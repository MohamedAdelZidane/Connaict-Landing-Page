      ...
      <div style={{overflowX: "hidden"}}>
        ...
        <Row id="content">
          <div className="col-md-6 col-12" id="leftColumn">
            ...
            <h5>Sign up to get shortlisted for interviews & hired at <br /> the top companies in Egypt</h5>
              <form
                id="loginForm"
                autoComplete="off"
              >
          ...
          <div className='col-md-6 col-6 d-none d-sm-block' >
            <Row id="features">
              ...
              <div className="col-10">
                ...
                <p>Sophisticated matching algorithms pairs you<br/> with suitable jobs based on your interest</p>

...
let filters = [
  { Field: "Title_en", Type: "TEXT", Values: "", Operator: "TEXT_EQUAL" },
  { Field: "Title_ar", Type: "TEXT", Values: "", Operator: "TEXT_EQUAL" },
  {
    Field: "IsActive",
    Type: "SELECT",
    Values: "",
...
class EnhancedTable extends Component {
  ...
  handleDeleteSelected = () => {
    this.props.deleteSlectedDownloads(JSON.stringify(this.state.selected));
  };
  ...
  handleDeleteButton = toBeDeleted => {
    if (!checkAuthorization("downloads_permissions", "can_delete_downloads")) {
      this.props.handleSnackBarMessage(
        "You don't have permission to delete Downloads",
        "error"
      );
    } else {
  ...
  render() {
    const { classes, tableTitle, handleEdit, handleDelete } = this.props;
    ...
    return (
      <div>
        <DeleteConfirmationDialog
          ...
          title="Deleting Downloadable"
          text="Are you sure you want to perform this action?"
          handleConfirmDelete={this.deleteBrands}
        />
                  ...
                  .map(n => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell padding="none">{n.Title_en}</TableCell>
                        <TableCell padding="none">{n.Title_ar}</TableCell>
                        <TableCell padding="none">
                          {parseInt(n.IsActive, 10) === 1 ? (
                        ...
                        <TableCell padding="none">
                          {n.CreatedAdmin[0] &&
                            n.CreatedAdmin[0].FirstName +
                              n.CreatedAdmin[0].LastName}
                        </TableCell>
                        <TableCell padding="none">
                        ...
                        <TableCell padding="none">
                          {n.UpdatedAdmin &&
                            n.UpdatedAdmin[0] &&
                            n.UpdatedAdmin[0].FirstName +
                              n.UpdatedAdmin[0].LastName}
                        </TableCell>
                        <TableCell padding="none">
                          <Tooltip title="Edit">
                            <IconButton

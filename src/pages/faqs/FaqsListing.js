...
let filters = [
  { Field: "Question_en", Type: "TEXT", Values: "", Operator: "TEXT_EQUAL" },
  { Field: "Question_ar", Type: "TEXT", Values: "", Operator: "TEXT_EQUAL" },
  {
    Field: "IsActive",
    Type: "SELECT",
    Values: "",
...
class EnhancedTable extends Component {
  ...
  handleDeleteSelected = () => {
    this.props.deleteSlectedFaqs(JSON.stringify(this.state.selected));
  };
  ...
  handleDeleteButton = toBeDeleted => {
    if (!checkAuthorization("faqs_permissions", "can_delete_faqs")) {
      this.props.handleSnackBarMessage(
        "You don't have permission to delete FAQ",
        "error"
      );
    } else {
    ...
    return (
      <div>
        <DeleteConfirmationDialog
          ...
          handleConfirmDelete={this.deleteFaqs}
        />
                  ...
                  .map(n => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell padding="none">{n.Question_en}</TableCell>
                        <TableCell padding="none">{n.Question_ar}</TableCell>

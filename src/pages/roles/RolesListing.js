...
//let SentStatus = "Sent"; // All , Sent , Non-Sent
...
class EnhancedTable extends Component {
  ...
  deleteRoles = () => {
    ...
    this.props.handleDeleteRole(toBeDeleted);
    this.setState({ selected: [] });
  };
  ...
  handleDeleteButton = toBeDeleted => {
    if (!checkAuthorization("roles_permissions", "can_delete_roles")) {
  ...
  handleOpenConfirmation = toBeDeleted => {
    this.setState({ deleteItems: toBeDeleted, open: true });
  };

  handleCloseConfirmation = () => {
    this.setState({ open: false, deleteItems: [] });
  };
      ...
      <div>
        ...
        >
          ...
          <DialogContent>{`Are you sure you want to delete ${
            ...
            this.state.deleteItems.length === 1 ? "Role" : "Roles"
          } `}</DialogContent>
          <DialogActions>
            <Button onClick={this.handleCloseConfirmation} color="primary">
              Cancel
            </Button>
            <Button onClick={this.deleteRoles} color="primary">
              Ok
            </Button>
          </DialogActions>
        </Dialog>
                  ...
                  .map(n => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell component="th" scope="row" padding="none">
                          <IconButton onClick={() => this.props.editRole(n)}>
